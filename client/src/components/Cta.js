        ...
        <div className="w-full flex items-center justify-center text-white cta">
            <div className="mx-8 w-full h-96 text-center lg:text-left py-16 px-12 flex lg:justify-between items-center">                    
                <div className="w-full flex flex-col lg:flex-row lg:justify-around">
                    <div className="mb-4">
                        <p className='text-2xl md:text-4xl font-bold mb-4'>Our story</p>
                        <p className="text-lg md:text-2xl">With a desire to bring health and sustainability to the world, Gary and Mary Young built Young Living from the ground up. After studying with the world's experts in essential oils, the Youngs began their first farm and distillery in 1994 and continue to share their mission and legacy with the world today. <span className='font-black'>together!</span></p>
                    </div>
